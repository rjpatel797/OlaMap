...
function initialize()
{
 ...
 //   $('#btnstart').attr('disabled', 'disabled');
   ...
   // alert(deviceid);
    var fromtime=dateconvert(stimes,$("#starttime").val());
    var totime=dateconvert(etimes,$("#endtime").val());
 ...
 for(var k=0;k<devicearry.length;k++)
   ...
   makemap(k);
        ...
        alert(devicearry.length);        
          //  alert("first KK:"+k);
         //  alert(devicearry[k]);
           var post_data="did="+devicearry[k]+"&sdate="+fromtime+"&edate="+totime+"&start=0&max=1000000";
           alert(post_data);
                  $.ajax({
                        type: "GET",
                        url: "deviceTracking/GetplaybackDatapersonal.jsp",
                        dataType: "json",
                        data: post_data,
            ...
            else
            {
                ...
                var infowindow1="<font size='2'>"+$("#"+devicearry[k]).val()+"<br/>Start("+points[0][3]+")</font>";
                var popupinfo={
                    text:infowindow1,
                    map:map,
                ...
                var m=-1;
                      ...
                      infowindow1="<font size='2'>"+$("#"+devicearry[k]).val()+" End ("+locations[locations.length-1][3]+")</font>";
               popupinfo={
                    text:infowindow1,
                    map:map,
                    icon : "deviceTracking/images/mm_20_gray.png",                   
